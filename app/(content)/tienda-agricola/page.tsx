...
import { categoriasInfo, productosPorCategoria, categorias, Categoria, Producto } from "./data/productos";
...
export default function TiendaAgricolaPage() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-emerald-50 via-green-50 to-blue-50">
      ...
      <section className="relative bg-linear-to-br from-emerald-600 via-green-600 to-teal-600 text-white overflow-hidden">
