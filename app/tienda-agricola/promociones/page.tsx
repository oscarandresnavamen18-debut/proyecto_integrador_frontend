...
import { Sparkles, Tag, ArrowLeft, TrendingDown, Loader2 } from "lucide-react";
...
export default function PromocionesPage() {
  ...
  // Cargar productos en promoción desde la API
  useEffect(() => {
  ...
  const descuentoMaximo = promociones.reduce(
    (max, p) => (p.descuento && p.descuento > max ? p.descuento : max),
    0
  );
          ...
          <div className="relative bg-linear-to-r from-red-500 via-pink-500 to-orange-500 rounded-3xl overflow-hidden mb-12 shadow-2xl">
            ...
            <div className="relative p-12 text-center text-white">
              ...
              <p className="text-2xl font-light mb-6 max-w-3xl mx-auto">
                Aprovecha descuentos de hasta <span className="font-bold text-3xl">{loading ? "..." : `${descuentoMaximo}%`}</span> en productos seleccionados
              </p>
          ...
          {error && !loading && (
            <div className="text-center py-16">
              ...
              <button
                ...
                className="mt-4 bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-xl font-semibold transition-colors"
              >
                Reintentar
              </button>
            </div>
